| package |
package := Package name: 'tpClinica (1) (1)'.
...
listadoObras
|codObra fechaInicio fechaFin auxObra subObras listado suma aux porc|
...
subObras do: [:i | 
Transcript show: (i fechaMinuta) printString.].
...
Transcript cr.
Transcript show: 'Nombre y apellido paciente: ',(((listado at: i)  pacienteMinuta) nombre , ((listado at: i)  pacienteMinuta) apellido) printString.
Transcript cr.
...
porc:= ((((listado at: i) servicioMinuta) costoSer)*(auxObra porcentaje)) / 100.
suma:=suma+porc.
Transcript cr.
Transcript show: 'Importe a pagar por la obra social: ',porc printString.] .
Transcript cr.
